      ...
      schemas: {
        User: {
          ...
          properties: {
            ...
            image: {
              ...
              nullable: true,
              example: null,
              description: "URL to user's profile image or null",
            },
            createdAt: {
              type: "string",
              format: "date-time",
        ...
        ApiKey: {
          ...
          properties: {
            ...
            start: { type: "string", nullable: true, example: "czb_", description: "Prefix of the API key" },
            prefix: { type: "string", nullable: true, example: "czb_", description: "Prefix of the API key" },
            key: {
              type: "string",
            ...
            enabled: { type: "boolean", nullable: true, example: true, description: "Whether the API key is enabled" },
            rateLimitEnabled: {
              type: "boolean",
              nullable: true,
              example: true,
            ...
            expiresAt: { type: "string", nullable: true, format: "date-time", description: "When the API key expires" },
        ...
        DropMissionCreate: {
          type: "object",
          description: "Mission definition; mirrors CreateDropMissionSchema (drops-schema.ts)",
          properties: {
            slug: { type: "string", example: "happy-hour-222", description: "Unique mission identifier" },
            name: { type: "string", example: "Happy Hour Transfer", description: "Display name" },
            description: { type: "string", description: "What the player must do and what they earn" },
            visibility: { type: "string", enum: ["PUBLISHED", "SECRET"], default: "PUBLISHED" },
            triggerMethod: { type: "string", enum: ["POST", "GET", "PUT", "DELETE"], default: "POST" },
            triggerPath: {
              type: "string",
              example: "/api/v1/transactions/create",
              description: "API path whose successful calls are evaluated",
            },
            timezone: { type: "string", default: "Europe/Prague", description: "IANA timezone for schedules" },
            definition: {
              type: "object",
              description: "Versioned rule DSL: { version: 1, schedule, progressMode, rule }",
              example: {
                version: 1,
            ...
            rewardType: {
              type: "string",
              enum: ["SUPER_TOKENS", "DISPLAY_TITLE"],
              description: "Only implemented reward types are accepted",
            },
            rewardPayload: {
              type: "object",
              nullable: true,
              description:
                "SUPER_TOKENS requires { amount: positive number }; DISPLAY_TITLE requires { text: non-empty string }",
              example: { amount: 50 },
            },
          ...
          required: ["slug", "name", "description", "triggerPath", "definition", "rewardType"],
        },
        DropMissionUpdate: {
          type: "object",
          description:
            "Partial DropMissionCreate: any subset of its fields; when rewardType is present, rewardPayload must match it",
